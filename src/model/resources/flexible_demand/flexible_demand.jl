    ...
    for z in 1:Z
        ...
        for y in FLEX_Z
            ...
            @constraint(EP, [t in 1:T],
                ...
                sum(EP[:vP][y, e]
                for e in hoursafter(hours_per_subperiod, t, 1:max_flex_demand_delay))>=EP[:vS_FLEX][
                    y,
                    t])
            ...
            @constraint(EP, [t in 1:T],
                ...
                for e in hoursafter(hours_per_subperiod, t, 1:max_flex_demand_advance))>=-EP[:vS_FLEX][
                    y,
                    t])
        end
    end
