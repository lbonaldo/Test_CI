...
function endogenous_retirement_discharge!(
    ...
    @expression(EP,
        ...
        sum(
            EP[:vCAPTRACK][y, p]
        for
        p in 1:get_retirement_stage(cur_stage, lifetime(gen[y]), stage_lens)
        ))
    @expression(EP,
