...
function long_duration_storage!(EP::Model, inputs::Dict, setup::Dict)
    ...
    @constraint(EP,
        ...
        vSOCw[y,mod1(r + 1, NPeriods)]==vSOCw[y, r] +
    ...
    @constraint(EP,
        ...
        vSOCw[y,r]==EP[:vS][y, hours_per_subperiod * dfPeriodMap[r, :Rep_Period_Index]] -
                    vdSOC[y, dfPeriodMap[r, :Rep_Period_Index]])
    ...
    if CapacityReserveMargin > 0
        ...
        @constraint(EP,
            ...
            EP[:vCAPRES_socinreserve][y,hours_per_subperiod * (w - 1) + 1] == 
                ...
                (1 / efficiency_down(gen[y]) * EP[:vCAPRES_discharge][y, hours_per_subperiod * (w - 1) + 1]) -
        ...
        @constraint(EP,
            cVSoCBalLongDurationStorage[y in STOR_LONG_DURATION,
                r in MODELED_PERIODS_INDEX],
            vCAPRES_socw[y,mod1(r + 1, NPeriods)] == vCAPRES_socw[y, r] +
        ...
        @constraint(EP,
            ...
            vCAPRES_socw[y,r] == EP[:vCAPRES_socinreserve][y,hours_per_subperiod * dfPeriodMap[r, :Rep_Period_Index]] -
                vCAPRES_dsoc[y, dfPeriodMap[r, :Rep_Period_Index]])
